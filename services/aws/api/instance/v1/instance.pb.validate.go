			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, CreateInstancesRequestValidationError{
						field:  fmt.Sprintf("BlockDeviceMapping[%v]", idx),
...
// CreateInstancesRequest_BlockDeviceMapping with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *CreateInstancesRequest_BlockDeviceMapping) Validate() error {
	return m.validate(false)
}
...
// CreateInstancesRequest_BlockDeviceMappingMultiError, or nil if none found.
func (m *CreateInstancesRequest_BlockDeviceMapping) ValidateAll() error {
	return m.validate(true)
}

func (m *CreateInstancesRequest_BlockDeviceMapping) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		switch v := interface{}(m.GetEbs()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, CreateInstancesRequest_BlockDeviceMappingValidationError{
					field:  "Ebs",
					reason: "embedded message failed validation",
					cause:  err,
				})
	...
	} else if v, ok := interface{}(m.GetEbs()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return CreateInstancesRequest_BlockDeviceMappingValidationError{
				field:  "Ebs",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if m.NoDevice != nil {
		// no validation rules for NoDevice
	}

	if m.VirtualName != nil {
		// no validation rules for VirtualName
	}

	if len(errors) > 0 {
		return CreateInstancesRequest_BlockDeviceMappingMultiError(errors)
	}

	return nil
}

// CreateInstancesRequest_BlockDeviceMappingMultiError is an error wrapping
// multiple validation errors returned by
// CreateInstancesRequest_BlockDeviceMapping.ValidateAll() if the designated
// constraints aren't met.
type CreateInstancesRequest_BlockDeviceMappingMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m CreateInstancesRequest_BlockDeviceMappingMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m CreateInstancesRequest_BlockDeviceMappingMultiError) AllErrors() []error { return m }

// CreateInstancesRequest_BlockDeviceMappingValidationError is the validation
// error returned by CreateInstancesRequest_BlockDeviceMapping.Validate if the
// designated constraints aren't met.
type CreateInstancesRequest_BlockDeviceMappingValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e CreateInstancesRequest_BlockDeviceMappingValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e CreateInstancesRequest_BlockDeviceMappingValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e CreateInstancesRequest_BlockDeviceMappingValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e CreateInstancesRequest_BlockDeviceMappingValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e CreateInstancesRequest_BlockDeviceMappingValidationError) ErrorName() string {
	return "CreateInstancesRequest_BlockDeviceMappingValidationError"
}

// Error satisfies the builtin error interface
func (e CreateInstancesRequest_BlockDeviceMappingValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sCreateInstancesRequest_BlockDeviceMapping.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = CreateInstancesRequest_BlockDeviceMappingValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = CreateInstancesRequest_BlockDeviceMappingValidationError{}

// Validate checks the field values on
// CreateInstancesRequest_BlockDeviceMapping_EbsBlockDevice with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *CreateInstancesRequest_BlockDeviceMapping_EbsBlockDevice) Validate() error {
	return m.validate(false)
}
...
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// CreateInstancesRequest_BlockDeviceMapping_EbsBlockDeviceMultiError, or nil
// if none found.
func (m *CreateInstancesRequest_BlockDeviceMapping_EbsBlockDevice) ValidateAll() error {
	return m.validate(true)
}

func (m *CreateInstancesRequest_BlockDeviceMapping_EbsBlockDevice) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if m.DeleteOnTermination != nil {
		// no validation rules for DeleteOnTermination
	}
	...
	if m.OutpostArn != nil {
		// no validation rules for OutpostArn
	}
	...
	if m.Throughput != nil {
		// no validation rules for Throughput
	}

	if m.VolumeSize != nil {
		// no validation rules for VolumeSize
	}

	if len(errors) > 0 {
		return CreateInstancesRequest_BlockDeviceMapping_EbsBlockDeviceMultiError(errors)
	}

	return nil
}

// CreateInstancesRequest_BlockDeviceMapping_EbsBlockDeviceMultiError is an
// error wrapping multiple validation errors returned by
// CreateInstancesRequest_BlockDeviceMapping_EbsBlockDevice.ValidateAll() if
// the designated constraints aren't met.
type CreateInstancesRequest_BlockDeviceMapping_EbsBlockDeviceMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m CreateInstancesRequest_BlockDeviceMapping_EbsBlockDeviceMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m CreateInstancesRequest_BlockDeviceMapping_EbsBlockDeviceMultiError) AllErrors() []error {
	return m
}

// CreateInstancesRequest_BlockDeviceMapping_EbsBlockDeviceValidationError is
// the validation error returned by
// CreateInstancesRequest_BlockDeviceMapping_EbsBlockDevice.Validate if the
// designated constraints aren't met.
type CreateInstancesRequest_BlockDeviceMapping_EbsBlockDeviceValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e CreateInstancesRequest_BlockDeviceMapping_EbsBlockDeviceValidationError) Field() string {
	return e.field
}

// Reason function returns reason value.
func (e CreateInstancesRequest_BlockDeviceMapping_EbsBlockDeviceValidationError) Reason() string {
	return e.reason
}

// Cause function returns cause value.
func (e CreateInstancesRequest_BlockDeviceMapping_EbsBlockDeviceValidationError) Cause() error {
	return e.cause
}

// Key function returns key value.
func (e CreateInstancesRequest_BlockDeviceMapping_EbsBlockDeviceValidationError) Key() bool {
	return e.key
}

// ErrorName returns error name.
func (e CreateInstancesRequest_BlockDeviceMapping_EbsBlockDeviceValidationError) ErrorName() string {
	return "CreateInstancesRequest_BlockDeviceMapping_EbsBlockDeviceValidationError"
}

// Error satisfies the builtin error interface
func (e CreateInstancesRequest_BlockDeviceMapping_EbsBlockDeviceValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sCreateInstancesRequest_BlockDeviceMapping_EbsBlockDevice.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = CreateInstancesRequest_BlockDeviceMapping_EbsBlockDeviceValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = CreateInstancesRequest_BlockDeviceMapping_EbsBlockDeviceValidationError{}
