...
type CreateInstanceRequest struct {
	...
	CpuCoreCount int32 `protobuf:"varint,7,opt,name=cpu_core_count,json=cpuCoreCount,proto3" json:"cpu_core_count,omitempty"`
	// The number of threads per CPU core. To disable multithreading for the instance, specify a value of 1. Otherwise, specify the default value of 2.
	ThreadsPerCore int32 `protobuf:"varint,8,opt,name=threads_per_core,json=threadsPerCore,proto3" json:"threads_per_core,omitempty"`
	// 系统盘大小
	SystemDiskSize string `protobuf:"bytes,9,opt,name=system_disk_size,json=systemDiskSize,proto3" json:"system_disk_size,omitempty"`
	// 是否为instance_name自动添加有序后缀（默认false）
	UniqueSuffix bool `protobuf:"varint,10,opt,name=unique_suffix,json=uniqueSuffix,proto3" json:"unique_suffix,omitempty"`
	// 创建数量(1-100，默认1)
	Amount uint32 `protobuf:"varint,11,opt,name=amount,proto3" json:"amount,omitempty"`
	// 实例密码
...
type CreateInstanceResponse struct {
	...
	// 实例id列表
	InstanceIdSets []*InstanceObj `protobuf:"bytes,2,rep,name=instance_id_sets,json=instanceIdSets,proto3" json:"instance_id_sets,omitempty"`
...
func (x *CreateInstanceResponse) GetGroupSet() []*GroupIdentifier {
	if x != nil {
		return x.GroupSet
	}
	return nil
...
func (x *CreateInstanceResponse) GetInstanceIdSets() []*InstanceObj {
	if x != nil {
...
type InstanceObj struct {
	...
	EbsOptimized bool `protobuf:"varint,6,opt,name=ebs_optimized,json=ebsOptimized,proto3" json:"ebs_optimized,omitempty"`
	// Specifies whether enhanced networking with ENA is enabled.
	EnaSupport bool `protobuf:"varint,7,opt,name=ena_support,json=enaSupport,proto3" json:"ena_support,omitempty"`
	// The security groups for the instance.
	GroupSet []*GroupIdentifier `protobuf:"bytes,8,rep,name=group_set,json=groupSet,proto3" json:"group_set,omitempty"`
	// The hypervisor type of the instance. The value xen is used for both Xen and Nitro hypervisors.
	// Valid Values: ovm | xen
	Hypervisor string `protobuf:"bytes,9,opt,name=hypervisor,proto3" json:"hypervisor,omitempty"`
	...
	InstanceLifecycle string `protobuf:"bytes,12,opt,name=instance_lifecycle,json=instanceLifecycle,proto3" json:"instance_lifecycle,omitempty"`
	// The current state of the instance.
	InstanceState *InstanceState `protobuf:"bytes,13,opt,name=instance_state,json=instanceState,proto3" json:"instance_state,omitempty"`
	// The instance type.
	...
	Ipv4Address string `protobuf:"bytes,15,opt,name=ipv4_address,json=ipv4Address,proto3" json:"ipv4_address,omitempty"`
	// The IPv6 address assigned to the instance.
	Ipv6Address string `protobuf:"bytes,16,opt,name=ipv6_address,json=ipv6Address,proto3" json:"ipv6_address,omitempty"`
	// The kernel associated with this instance, if applicable.
	KernelId string `protobuf:"bytes,17,opt,name=kernel_id,json=kernelId,proto3" json:"kernel_id,omitempty"`
	// The name of the key pair, if this instance was launched with an associated key pair.
	KeyName string `protobuf:"bytes,18,opt,name=key_name,json=keyName,proto3" json:"key_name,omitempty"`
	// The time the instance was launched.
	LaunchTime string `protobuf:"bytes,19,opt,name=launch_time,json=launchTime,proto3" json:"launch_time,omitempty"`
	// The monitoring for the instance.
	Monitoring *InstanceObj_Monitoring `protobuf:"bytes,20,opt,name=monitoring,proto3" json:"monitoring,omitempty"`
	// The value is Windows for Windows instances; otherwise blank.
	Platform string `protobuf:"bytes,21,opt,name=platform,proto3" json:"platform,omitempty"`
	// The platform details value for the instance. For more information, see AMI billing information fields in the Amazon EC2 User Guide.
	PlatformDetails string `protobuf:"bytes,22,opt,name=platform_details,json=platformDetails,proto3" json:"platform_details,omitempty"`
	// (IPv4 only) The private DNS hostname name assigned to the instance. This DNS hostname can only be used inside the Amazon EC2 network. This name is not available until the instance enters the running state.
	PrivateDnsName string `protobuf:"bytes,23,opt,name=private_dns_name,json=privateDnsName,proto3" json:"private_dns_name,omitempty"`
	// The options for the instance hostname.
	PrivateDnsNameOptionsResponse *InstanceObj_PrivateDnsNameOptionsResponse `protobuf:"bytes,24,opt,name=privateDnsNameOptionsResponse,proto3" json:"privateDnsNameOptionsResponse,omitempty"`
	// The private IPv4 address assigned to the instance.
	PrivateIpAddress string `protobuf:"bytes,25,opt,name=privateIpAddress,proto3" json:"privateIpAddress,omitempty"`
	// The RAM disk associated with this instance, if applicable.
	RamdiskId string `protobuf:"bytes,26,opt,name=ramdisk_id,json=ramdiskId,proto3" json:"ramdisk_id,omitempty"`
	// The reason for the most recent state transition. This might be an empty string.
	Reason string `protobuf:"bytes,27,opt,name=reason,proto3" json:"reason,omitempty"`
	// The device name of the root device volume (for example, /dev/sda1).
	RootDeviceName string `protobuf:"bytes,28,opt,name=root_device_name,json=rootDeviceName,proto3" json:"root_device_name,omitempty"`
	// The root device type used by the AMI. The AMI can use an EBS volume or an instance store volume.
	RootDeviceType string `protobuf:"bytes,29,opt,name=root_device_type,json=rootDeviceType,proto3" json:"root_device_type,omitempty"`
}
...
func (x *InstanceObj) GetDnsName() string {
	if x != nil {
		return x.DnsName
	}
	return ""
...
func (x *InstanceObj) GetGroupSet() []*GroupIdentifier {
	if x != nil {
		return x.GroupSet
	}
	return nil
...
func (x *InstanceObj) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
type ListInstanceResponse struct {
	...
	ReservationSet []*ListInstanceResponse_Reservation `protobuf:"bytes,3,rep,name=reservation_set,json=reservationSet,proto3" json:"reservation_set,omitempty"`
}
...
type StartInstanceResponse struct {
	...
	InstancesSet []*InstanceStateChange `protobuf:"bytes,1,rep,name=instances_set,json=instancesSet,proto3" json:"instances_set,omitempty"`
	// 请求ID
...
func (x *StartInstanceResponse) GetInstancesSet() []*InstanceStateChange {
	if x != nil {
...
type StopInstanceResponse struct {
	...
	InstancesSet []*InstanceStateChange `protobuf:"bytes,2,rep,name=instances_set,json=instancesSet,proto3" json:"instances_set,omitempty"`
}
...
func (x *StopInstanceResponse) GetInstancesSet() []*InstanceStateChange {
	if x != nil {
		return x.InstancesSet
	}
	return nil
...
func (x *RebootInstanceResponse) GetResult() bool {
	if x != nil {
		return x.Result
	}
	return false
...
func (x *DeleteInstanceResponse) GetInstancesSet() []*InstanceStateChange {
	if x != nil {
		return x.InstancesSet
	}
	return nil
...
type ListInstanceTypeResponse_InstanceType_InferenceAcceleratorInfo struct {
	...
	Accelerators []*ListInstanceTypeResponse_InstanceType_InferenceAcceleratorInfo `protobuf:"bytes,1,rep,name=accelerators,proto3" json:"accelerators,omitempty"`
}
...
func (x *ListInstanceTypeResponse_InstanceType_InferenceAcceleratorInfo) GetAccelerators() []*ListInstanceTypeResponse_InstanceType_InferenceAcceleratorInfo {
	if x != nil {
...
var file_services_aws_api_instance_v1_instance_proto_rawDesc = []byte{
	...
	0x70, 0x69, 0x2e, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x2e, 0x76, 0x31, 0x22, 0x99,
	...
	,
	...
	0x22, 0xc8, 0x0c, 0x0a, 0x0b, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x4f, 0x62, 0x6a,
	...
	,
	...
	0x66, 0x65, 0x63, 0x79, 0x63, 0x6c, 0x65, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x09, 0x52, 0x11, 0x69,
	0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x4c, 0x69, 0x66, 0x65, 0x63, 0x79, 0x63, 0x6c, 0x65,
	0x12, 0x45, 0x0a, 0x0e, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x5f, 0x73, 0x74, 0x61,
	0x74, 0x65, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x69,
	...
	0x63, 0x65, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x23, 0x0a, 0x0d, 0x69, 0x6e, 0x73, 0x74, 0x61,
	0x6e, 0x63, 0x65, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c,
	0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12, 0x21, 0x0a, 0x0c,
	0x69, 0x70, 0x76, 0x34, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x0f, 0x20, 0x01,
	...
	,
	...
	0x65, 0x6e, 0x12, 0x5a, 0x0a, 0x0f, 0x72, 0x65, 0x73, 0x65, 0x72, 0x76, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x5f, 0x73, 0x65, 0x74, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x31, 0x2e, 0x61, 0x70,
	...
	,
	...
	0x6f, 0x6e, 0x49, 0x64, 0x22, 0x56, 0x0a, 0x11, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x67, 0x69,
	0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x22, 0x0a, 0x0d, 0x61, 0x63, 0x63,
	...
	0x09, 0x52, 0x09, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x4b, 0x65, 0x79, 0x22, 0xd3, 0x01, 0x0a,
	...
	,
	...
	0x6e, 0x22, 0xba, 0x05, 0x0a, 0x11, 0x4c, 0x69, 0x73, 0x74, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x40, 0x0a, 0x06, 0x69, 0x6d, 0x61, 0x67, 0x65,
	0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x69, 0x6e,
	...
	0x65, 0x52, 0x06, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x73, 0x1a, 0xe2, 0x04, 0x0a, 0x05, 0x49, 0x6d,
	...
	,
	...
	0x6d, 0x5f, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x18, 0x12, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e,
	0x70, 0x6c, 0x61, 0x74, 0x66, 0x6f, 0x72, 0x6d, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x22, 0xb4,
	0x01, 0x0a, 0x17, 0x4c, 0x69, 0x73, 0x74, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x54,
	0x79, 0x70, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x22, 0x0a, 0x0d, 0x61, 0x63,
	...
	,
	...
	0xc4, 0x1e, 0x0a, 0x0c, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x54, 0x79, 0x70, 0x65,
	0x12, 0x36, 0x0a, 0x17, 0x61, 0x75, 0x74, 0x6f, 0x5f, 0x72, 0x65, 0x63, 0x6f, 0x76, 0x65, 0x72,
	0x79, 0x5f, 0x73, 0x75, 0x70, 0x70, 0x6f, 0x72, 0x74, 0x65, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x15, 0x61, 0x75, 0x74, 0x6f, 0x52, 0x65, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x79, 0x53,
	0x75, 0x70, 0x70, 0x6f, 0x72, 0x74, 0x65, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x62, 0x61, 0x72, 0x65,
	0x5f, 0x6d, 0x65, 0x74, 0x61, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x09, 0x62, 0x61,
	0x72, 0x65, 0x4d, 0x65, 0x74, 0x61, 0x6c, 0x12, 0x46, 0x0a, 0x1f, 0x62, 0x75, 0x72, 0x73, 0x74,
	...
	,
	...
	0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x54, 0x79, 0x70, 0x65, 0x2e, 0x49, 0x6e, 0x66, 0x65, 0x72,
	0x65, 0x6e, 0x63, 0x65, 0x41, 0x63, 0x63, 0x65, 0x6c, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x49,
	0x6e, 0x66, 0x6f, 0x52, 0x18, 0x69, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x41, 0x63,
	0x63, 0x65, 0x6c, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x7e, 0x0a,
	0x15, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x5f, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67,
	0x65, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x4a, 0x2e, 0x61,
	...
	0x54, 0x79, 0x70, 0x65, 0x2e, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x53, 0x74, 0x6f,
	0x72, 0x61, 0x67, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x13, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e,
	0x63, 0x65, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x3c, 0x0a,
	0x1a, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x5f, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67,
	0x65, 0x5f, 0x73, 0x75, 0x70, 0x70, 0x6f, 0x72, 0x74, 0x65, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x18, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x53, 0x74, 0x6f, 0x72, 0x61,
	0x67, 0x65, 0x53, 0x75, 0x70, 0x70, 0x6f, 0x72, 0x74, 0x65, 0x64, 0x12, 0x23, 0x0a, 0x0d, 0x69,
	...
	0x12, 0x62, 0x0a, 0x0b, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18,
	0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x41, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x69, 0x6e, 0x73, 0x74,
	...
	0x2e, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x54, 0x79, 0x70, 0x65, 0x2e, 0x4d, 0x65,
	0x6d, 0x6f, 0x72, 0x79, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x0a, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79,
	0x49, 0x6e, 0x66, 0x6f, 0x1a, 0xbc, 0x03, 0x0a, 0x07, 0x47, 0x70, 0x75, 0x49, 0x6e, 0x66, 0x6f,
	0x12, 0x60, 0x0a, 0x04, 0x67, 0x70, 0x75, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x4c,
	0x2e, 0x61, 0x70, 0x69, 0x2e, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x2e, 0x76, 0x31,
	...
	0x63, 0x65, 0x54, 0x79, 0x70, 0x65, 0x2e, 0x47, 0x70, 0x75, 0x49, 0x6e, 0x66, 0x6f, 0x2e, 0x47,
	0x70, 0x75, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x67, 0x70,
	0x75, 0x73, 0x12, 0x34, 0x0a, 0x17, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x5f, 0x67, 0x70, 0x75, 0x5f,
	0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x5f, 0x69, 0x6e, 0x5f, 0x6d, 0x69, 0x62, 0x18, 0x07, 0x20,
	0x01, 0x28, 0x05, 0x52, 0x13, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x47, 0x70, 0x75, 0x4d, 0x65, 0x6d,
	0x6f, 0x72, 0x79, 0x49, 0x6e, 0x4d, 0x69, 0x62, 0x1a, 0x98, 0x02, 0x0a, 0x0d, 0x47, 0x70, 0x75,
	0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x14, 0x0a, 0x05, 0x63, 0x6f,
	...
	,
	...
	0x74, 0x6f, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x0c, 0x61, 0x63, 0x63, 0x65, 0x6c, 0x65, 0x72,
	0x61, 0x74, 0x6f, 0x72, 0x73, 0x1a, 0x63, 0x0a, 0x13, 0x49, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e,
	0x63, 0x65, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x14, 0x0a, 0x05,
	...
	0x63, 0x74, 0x75, 0x72, 0x65, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x1a, 0xcf, 0x02, 0x0a, 0x13, 0x49,
	0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x49, 0x6e,
	0x66, 0x6f, 0x12, 0x69, 0x0a, 0x05, 0x64, 0x69, 0x73, 0x6b, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x53, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x79, 0x49, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x5f, 0x6b, 0x65,
	...
	,
	...
	,
	...
	0x12, 0x1f, 0x0a, 0x0b, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x18,
	0x04, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0a, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x49,
	0x64, 0x22, 0x80, 0x01, 0x0a, 0x14, 0x53, 0x74, 0x6f, 0x70, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e,
	...
	0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x49, 0x64, 0x12, 0x49, 0x0a, 0x0d, 0x69, 0x6e, 0x73,
	0x74, 0x61, 0x6e, 0x63, 0x65, 0x73, 0x5f, 0x73, 0x65, 0x74, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x24, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x2e,
	0x76, 0x31, 0x2e, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x53, 0x74, 0x61, 0x74, 0x65,
	0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x52, 0x0c, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65,
	0x73, 0x53, 0x65, 0x74, 0x22, 0x93, 0x01, 0x0a, 0x15, 0x52, 0x65, 0x62, 0x6f, 0x6f, 0x74, 0x49,
	...
	0x09, 0x52, 0x06, 0x72, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x12, 0x1f, 0x0a, 0x0b, 0x69, 0x6e, 0x73,
	0x74, 0x61, 0x6e, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0a,
	0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x49, 0x64, 0x22, 0x4f, 0x0a, 0x16, 0x52, 0x65,
	...
	0x01, 0x28, 0x08, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x93, 0x01, 0x0a, 0x15,
	...
	0x12, 0x1f, 0x0a, 0x0b, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x18,
	0x04, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0a, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x49,
	0x64, 0x22, 0x82, 0x01, 0x0a, 0x16, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x49, 0x6e, 0x73, 0x74,
	...
	0x52, 0x09, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x49, 0x64, 0x12, 0x49, 0x0a, 0x0d, 0x69,
	0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x73, 0x5f, 0x73, 0x65, 0x74, 0x18, 0x02, 0x20, 0x03,
	...
	,
	...
	,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x5b, 0x0a, 0x0c, 0x53, 0x74, 0x6f, 0x70, 0x49,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x61, 0x0a, 0x0e, 0x52, 0x65, 0x62, 0x6f, 0x6f, 0x74, 0x49, 0x6e,
	...
	0x63, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x2b, 0x0a, 0x0f, 0x61, 0x70,
	0x69, 0x2e, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x2e, 0x76, 0x31, 0x50, 0x01, 0x5a,
	0x16, 0x61, 0x77, 0x73, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63,
...
var file_services_aws_api_instance_v1_instance_proto_depIdxs = []int32{
	3,  // 0: api.instance.v1.CreateInstanceResponse.group_set:type_name -> api.instance.v1.GroupIdentifier
	4,  // 1: api.instance.v1.CreateInstanceResponse.instance_id_sets:type_name -> api.instance.v1.InstanceObj
	22, // 2: api.instance.v1.InstanceObj.cpu_options:type_name -> api.instance.v1.InstanceObj.CpuOptions
	3,  // 3: api.instance.v1.InstanceObj.group_set:type_name -> api.instance.v1.GroupIdentifier
	13, // 4: api.instance.v1.InstanceObj.instance_state:type_name -> api.instance.v1.InstanceState
	23, // 5: api.instance.v1.InstanceObj.monitoring:type_name -> api.instance.v1.InstanceObj.Monitoring
	24, // 6: api.instance.v1.InstanceObj.privateDnsNameOptionsResponse:type_name -> api.instance.v1.InstanceObj.PrivateDnsNameOptionsResponse
	25, // 7: api.instance.v1.ListInstanceResponse.reservation_set:type_name -> api.instance.v1.ListInstanceResponse.Reservation
	26, // 8: api.instance.v1.ListRegionResponse.regions:type_name -> api.instance.v1.ListRegionResponse.Region
	27, // 9: api.instance.v1.ListImageResponse.images:type_name -> api.instance.v1.ListImageResponse.Image
	28, // 10: api.instance.v1.ListInstanceTypeResponse.instance_types:type_name -> api.instance.v1.ListInstanceTypeResponse.InstanceType
	13, // 11: api.instance.v1.InstanceStateChange.current_state:type_name -> api.instance.v1.InstanceState
	13, // 12: api.instance.v1.InstanceStateChange.previous_state:type_name -> api.instance.v1.InstanceState
	14, // 13: api.instance.v1.StartInstanceResponse.instances_set:type_name -> api.instance.v1.InstanceStateChange
	14, // 14: api.instance.v1.StopInstanceResponse.instances_set:type_name -> api.instance.v1.InstanceStateChange
	14, // 15: api.instance.v1.DeleteInstanceResponse.instances_set:type_name -> api.instance.v1.InstanceStateChange
	3,  // 16: api.instance.v1.ListInstanceResponse.Reservation.group_set:type_name -> api.instance.v1.GroupIdentifier
	4,  // 17: api.instance.v1.ListInstanceResponse.Reservation.instancesSet:type_name -> api.instance.v1.InstanceObj
	30, // 18: api.instance.v1.ListInstanceTypeResponse.InstanceType.inferenceAcceleratorInfo:type_name -> api.instance.v1.ListInstanceTypeResponse.InstanceType.InferenceAcceleratorInfo
	31, // 19: api.instance.v1.ListInstanceTypeResponse.InstanceType.instance_storage_info:type_name -> api.instance.v1.ListInstanceTypeResponse.InstanceType.InstanceStorageInfo
	32, // 20: api.instance.v1.ListInstanceTypeResponse.InstanceType.memory_info:type_name -> api.instance.v1.ListInstanceTypeResponse.InstanceType.MemoryInfo
	34, // 21: api.instance.v1.ListInstanceTypeResponse.InstanceType.GpuInfo.gpus:type_name -> api.instance.v1.ListInstanceTypeResponse.InstanceType.GpuInfo.GpuDeviceInfo
	30, // 22: api.instance.v1.ListInstanceTypeResponse.InstanceType.InferenceAcceleratorInfo.accelerators:type_name -> api.instance.v1.ListInstanceTypeResponse.InstanceType.InferenceAcceleratorInfo
	37, // 23: api.instance.v1.ListInstanceTypeResponse.InstanceType.InstanceStorageInfo.disks:type_name -> api.instance.v1.ListInstanceTypeResponse.InstanceType.InstanceStorageInfo.DiskInfo
	38, // 24: api.instance.v1.ListInstanceTypeResponse.InstanceType.NetworkInfo.efa_info:type_name -> api.instance.v1.ListInstanceTypeResponse.InstanceType.NetworkInfo.EfaInfo
	33, // 25: api.instance.v1.ListInstanceTypeResponse.InstanceType.NetworkInfo.networkInfo:type_name -> api.instance.v1.ListInstanceTypeResponse.InstanceType.NetworkInfo
	40, // 26: api.instance.v1.ListInstanceTypeResponse.InstanceType.NetworkInfo.placement_group_info:type_name -> api.instance.v1.ListInstanceTypeResponse.InstanceType.NetworkInfo.PlacementGroupInfo
	41, // 27: api.instance.v1.ListInstanceTypeResponse.InstanceType.NetworkInfo.processor_info:type_name -> api.instance.v1.ListInstanceTypeResponse.InstanceType.NetworkInfo.ProcessorInfo
	42, // 28: api.instance.v1.ListInstanceTypeResponse.InstanceType.NetworkInfo.v_cpu_info:type_name -> api.instance.v1.ListInstanceTypeResponse.InstanceType.NetworkInfo.VCpuInfo
	35, // 29: api.instance.v1.ListInstanceTypeResponse.InstanceType.GpuInfo.GpuDeviceInfo.memory_info:type_name -> api.instance.v1.ListInstanceTypeResponse.InstanceType.GpuInfo.GpuDeviceInfo.GpuDeviceMemoryInfo
	6,  // 30: api.instance.v1.Instance.ListRegion:input_type -> api.instance.v1.ListRegionRequest
	8,  // 31: api.instance.v1.Instance.ListImage:input_type -> api.instance.v1.ListImageRequest
	10, // 32: api.instance.v1.Instance.ListInstanceType:input_type -> api.instance.v1.ListInstanceTypeRequest
	0,  // 33: api.instance.v1.Instance.CreateInstance:input_type -> api.instance.v1.CreateInstanceRequest
	2,  // 34: api.instance.v1.Instance.ListInstance:input_type -> api.instance.v1.ListInstanceRequest
	12, // 35: api.instance.v1.Instance.StartInstance:input_type -> api.instance.v1.StartInstanceRequest
	16, // 36: api.instance.v1.Instance.StopInstance:input_type -> api.instance.v1.StopInstanceRequest
	18, // 37: api.instance.v1.Instance.RebootInstance:input_type -> api.instance.v1.RebootInstanceRequest
	20, // 38: api.instance.v1.Instance.DeleteInstance:input_type -> api.instance.v1.DeleteInstanceRequest
	7,  // 39: api.instance.v1.Instance.ListRegion:output_type -> api.instance.v1.ListRegionResponse
	9,  // 40: api.instance.v1.Instance.ListImage:output_type -> api.instance.v1.ListImageResponse
	11, // 41: api.instance.v1.Instance.ListInstanceType:output_type -> api.instance.v1.ListInstanceTypeResponse
	1,  // 42: api.instance.v1.Instance.CreateInstance:output_type -> api.instance.v1.CreateInstanceResponse
	5,  // 43: api.instance.v1.Instance.ListInstance:output_type -> api.instance.v1.ListInstanceResponse
	15, // 44: api.instance.v1.Instance.StartInstance:output_type -> api.instance.v1.StartInstanceResponse
	17, // 45: api.instance.v1.Instance.StopInstance:output_type -> api.instance.v1.StopInstanceResponse
	19, // 46: api.instance.v1.Instance.RebootInstance:output_type -> api.instance.v1.RebootInstanceResponse
	21, // 47: api.instance.v1.Instance.DeleteInstance:output_type -> api.instance.v1.DeleteInstanceResponse
